...
var View = /** @class */ (function (_super) {
    ...
    function View(props) {
        ...
        _this.onDelegateEvents = function (evt) {
            ...
            if (evt.delegateObject) {
                ...
                util_1.each(inhertNames, function (subName) {
    ...
    View.prototype.init = function () {
        ...
        this.initOptions();
        // 递归初始化子 view
        util_1.each(this.views, function (view) {
            view.init();
        });
    };
    /**
    ...
    View.prototype.clear = function () {
        ...
        // 2. 清空 geometries
        util_1.each(this.geometries, function (geometry) {
            geometry.clear();
        });
        this.geometries = [];
        // 3. 清空 controllers
        util_1.each(this.controllers, function (controller) {
            controller.clear();
        });
        // 4. 删除 scale 缓存
    ...
    View.prototype.getYScales = function () {
        ...
        return util_1.uniq(util_1.map(this.geometries, function (g) { return g.getYScale(); }));
    };
    /**
    ...
    View.prototype.getLegendAttributes = function () {
        return util_1.flatten(util_1.map(this.geometries, function (g) { return g.getGroupAttributes(); }));
    };
    /**
     * 获取所有的分组字段的 scale 实例。
    ...
    View.prototype.getGroupScales = function () {
        ...
        var scales = util_1.map(this.geometries, function (g) { return g.getGroupScales(); });
        return util_1.uniq(util_1.flatten(scales));
    };
    /**
     * 获取 G.Canvas 实例。
    ...
    View.prototype.filterFieldData = function (field, data) {
        ...
        return util_1.filter(data, function (datum, idx) { return condition(datum[field], datum, idx); });
    };
    /**
     * 调整 coordinate 的坐标范围。
     */
    ...
    View.prototype.initComponentController = function () {
        var _this = this;
        util_1.each(this.usedControllers, function (controllerName) {
    ...
    View.prototype.initGeometries = function (isUpdate) {
        ...
        util_1.each(this.geometries, function (geometry) {
            ...
            var cfg = {
                ...
                scaleDefs: util_1.get(_this.options, 'scales', {}),
    ...
    View.prototype.createOrUpdateScales = function () {
        ...
        util_1.each(fields, function (field) {
            var scaleDef = util_1.get(scales, [field]);
            // 调用方法，递归去创建
