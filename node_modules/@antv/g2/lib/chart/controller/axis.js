...
var Axis = /** @class */ (function (_super) {
    ...
    Axis.prototype.getLineAxisCfg = function (scale, axisOption, direction) {
        ...
        var baseAxisCfg = tslib_1.__assign(tslib_1.__assign({ container: container }, region), { ticks: util_1.map(scale.getTicks(), function (tick) { return ({ id: "" + tick.tickValue, name: tick.text, value: tick.value }); }), title: {
                text: titleText,
            }, verticalFactor: coordinate.isPolar
                ? axis_1.getAxisFactorByRegion(region, coordinate.getCenter()) * -1
                : axis_1.getAxisFactorByRegion(region, coordinate.getCenter()) });
        ...
        var optionWithTitle = util_1.get(axisOption, ['title'])
            ...
            : axisOption;
        var cfg = util_1.deepMix({}, baseAxisCfg, axisThemeCfg, optionWithTitle);
        return util_1.mix(cfg, this.getAnimateCfg(cfg));
    };
    /**
    ...
    Axis.prototype.getCircleAxisCfg = function (scale, axisOption, direction) {
        var container = this.axisContainer;
        var ticks = util_1.map(scale.getTicks(), function (tick) { return ({ id: "" + tick.tickValue, name: tick.text, value: tick.value }); });
        var coordinate = this.view.getCoordinate();
        ...
        var titleText = axis_1.getAxisTitleText(scale, axisOption);
        var baseAxisCfg = tslib_1.__assign(tslib_1.__assign({ container: container }, axis_1.getCircleAxisCenterRadius(this.view.getCoordinate())), { ticks: ticks, title: {
                text: titleText,
            }, verticalFactor: 1 });
    ...
    Axis.prototype.getAnimateCfg = function (cfg) {
        return {
            ...
            animateOption: util_1.deepMix({}, animate_1.DEFAULT_ANIMATE_CFG, {
                appear: null,
            }, util_1.get(cfg, 'animateOption', {})),
        };
    };
    return Axis;
}(base_1.Controller));
