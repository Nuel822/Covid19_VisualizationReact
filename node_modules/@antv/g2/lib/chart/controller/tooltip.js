...
var Tooltip = /** @class */ (function (_super) {
    ...
    Tooltip.prototype.getTooltipItems = function (point) {
        ...
        if (items.length) {
            ...
            util_1.each(items, function (itemArr) {
                util_1.each(itemArr, function (item) {
            ...
            if (shared === false && items.length > 1) {
                ...
                util_1.each(items, function (aItem) {
    ...
    Tooltip.prototype.getTooltipItemsByFindData = function (geometry, point, title) {
        var result = [];
        util_1.each(geometry.dataArray, function (data) {
    ...
    Tooltip.prototype.findItemsFromView = function (view, point) {
        ...
        // 递归查找，并合并结果
        util_1.each(view.views, function (childView) {
