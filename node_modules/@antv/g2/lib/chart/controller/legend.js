...
var Legend = /** @class */ (function (_super) {
    ...
    Legend.prototype.getContinuousCfg = function (geometry, attr, scale, legendOption) {
        ...
        var items = util_1.map(ticks, function (tick) {
        ...
        if (attr.type === 'size') {
            attrLegendCfg = tslib_1.__assign(tslib_1.__assign({}, attrLegendCfg), { track: {
                    style: {
        ...
        if (attr.type === 'color') {
            attrLegendCfg = tslib_1.__assign(tslib_1.__assign({}, attrLegendCfg), { colors: util_1.map(items, function (item) { return item.attrValue; }) });
        }
        ...
        // 基础配置，从当前数据中读到的配置
        var baseCfg = tslib_1.__assign(tslib_1.__assign({ container: container,
    ...
    Legend.prototype.getCategoryCfg = function (geometry, attr, scale, legendOption, custom) {
        ...
        var baseCfg = tslib_1.__assign({ container: container,
            layout: layout,
            items: items,
    ...
    Legend.prototype.mergeLegendCfg = function (baseCfg, legendOption, direction) {
        ...
        return util_1.deepMix({}, themeObject, baseCfg, {
            animateOption: animate_1.DEFAULT_ANIMATE_CFG,
        }, legendOption);
    };
    /**
     * 生成 id
